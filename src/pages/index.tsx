    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>COCOO</h1>
        ...
        <div className='hidden md:flex pr-4'>
          ...
          <button className='px-8 py-3 bg-indigo-300 text-white rounded-md'>Sign Up</button>
        </div> 
        <div className='md:hidden mr-4' onClick={handleClick}>
            {!nav ? <UserIcon className='w-5' /> : <Bars3Icon  className='w-5' />}
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8 md:hidden'}>
        ...
        <div className='flex flex-col my-4'>
            <button className='bg-transparent bg-indigo-600 px-8 py-3 mb-4 rounded-md text-white'>Sign In</button>
